...
CREATE TABLE `tblviolation` (
  ...
  `coor_x` varchar(45) DEFAULT NULL,
  `coor_y` varchar(45) DEFAULT NULL,
  `details` longtext,
  `usedgear` varchar(45) DEFAULT NULL,
  `usedboat` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`vid`)
...
INSERT INTO `tblviolation` VALUES ('San-26471-1','San-26471','Dynamite Fishing','Brgy Ermita','Apr 06, 2022','','','','','Dynamite Fishing','Fb Catalino');
