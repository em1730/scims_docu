...
$get_all_position_sql = "SELECT * FROM tbl_position where department='$department'";
            ...
            <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="email" class="form-control" name="email" placeholder="Email Address" value="<?php echo $db_email_ad; ?>" required>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                      <input type="contact_no" class="form-control" name="contact_number" placeholder="Contact Number" value="<?php echo $db_contact_no;?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control select2" id="select_department" style="width: 100%;" name="department" value="<?php echo
$department; ?>">
...
<?php while ($get_department = $get_all_department_data->fetch(PDO::FETCH_ASSOC)) { ?>
  ...
  <?php
    ...
    $selected = ($department == $get_department['objid'])? 'selected':'';

?>
    <option <?=$selected;?> value="<?php echo $get_department['objid']; ?>"><?php echo $get_department['department']; ?></option>
<?php } ?>
                ...
                <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control select2" id="select_position" style="width: 100%;" name="position" value="<?php echo
$position; ?>">
                                                    <option>Please select...</option>
<?php while ($get_position = $get_all_position_data->fetch(PDO::FETCH_ASSOC)) { ?>
  ...
  <?php
    //if $get_author naa value, check nato if equals sa $get_author1['fullname']
    //if equals, put 'selected' sa option
    $selected = ($position == $get_position['objid'])? 'selected':'';

?>
    <option <?=$selected;?> value="<?php echo $get_position['objid']; ?>"><?php echo $get_position['position']; ?></option>
<?php } ?>
