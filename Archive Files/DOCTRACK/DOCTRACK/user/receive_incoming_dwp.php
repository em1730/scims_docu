...
$get_all_incoming_sql = "SELECT * FROM tbl_dwp where docno = :doc";// and destination = '$department'";
...
//select all payee
$get_all_payee_sql = "SELECT * FROM tbl_payee";
...
$dv_no; ?>" required>
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" id="dv_no" name="acct_number"  placeholder="DV Number" value="<?php echo
$acct_no; ?>" required>
                  </div>
                </div><br>
...
<?php
    //if $get_author naa value, check nato if equals sa $get_author1['fullname']
    //if equals, put 'selected' sa option
    $selected = ($payee == $get_payee['objid'])? 'selected':'';

?>

<option <?=$selected;?> value="<?php echo $get_payee['objid']; ?>"><?php echo $get_payee['payee']; ?></option>
<?php } ?>
                                            </select>
                                        </div>
                                    </div><br>
