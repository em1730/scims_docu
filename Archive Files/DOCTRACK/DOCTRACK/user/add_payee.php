...
$newposition=$objid= $status=$payee=$address='';
$alert_msg ='';
$btnNew = 'disabled';
$btnStatus = '';
 ...
 <section class="content">
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Payee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
$objid; ?>" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <textarea rows="5" class="form-control" name="payee" placeholder="Payee"  required><?php echo
$payee; ?></textarea>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <textarea rows="5" class="form-control" name="address" placeholder="Address"  required><?php echo
$address; ?></textarea>
                  </div>
                </div><br>
