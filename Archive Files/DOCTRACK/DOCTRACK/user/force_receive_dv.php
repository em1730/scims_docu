...
$alert_msg = '';
$docno = $date = $type= $particulars = $origin = $destination = $obr_no = $account = $dv_no = $cheque_no =$acct_no = $amount  =$payee=  $status = $date_received = $remarks = $user_name = '';
$btnNew = 'disabled';
$btnPrint = 'disabled';
$btnStatus = '';
...
//select all payee
$get_all_payee_sql = "SELECT * FROM tbl_suppliers order by name_supplier";
            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly id="doc_no" class="form-control" name="doc_no" placeholder="Document Number" value="<?php echo
$docno; ?>" required>
                  </div>
                </div><br>
...
$type; ?>">
                  ...
                  <div class="col-md-10">
                      ...
                      <input type="text"  class="form-control" id="obr_no" name="obr_number"  placeholder="OBR Number" value="<?php echo
$obr_no; ?>">
                  </div>
                </div><br>
                <div class="row">
...
$dv_no; ?>" >
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" id="acct_no" name="acct_number"  placeholder="Account Number" value="<?php echo
$acct_no; ?>">
                  </div>
                </div><br>
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                      <input type="text"  class="form-control" id="cheque_number" name="cheque_number"  placeholder="Cheque Number" value="<?php echo
$cheque_no; ?>">
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      ...
                      <input type="text" readonly  id="payee" class="form-control" name="payee" placeholder="Payee"  value="<?php echo
$payee; ?>">
                  </div>
                </div><br>        
                  ...
                  <div class="col-md-10">
                      <textarea rows="5" id="particulars" class="form-control" name="particulars" placeholder="Subject/Particulars"  required><?php echo
...
$('#select_account').on('change',function(){
  ...
  var dvno    = $('#dv_no').val();      
            $.ajax({
              type:'POST',
              data:{account:account,type:type,office:office,dv:dvno},
              url:'generate_dv.php',
...
$(function(){
  $('#doc_no').val(sessionStorage.getItem("docno"));
  ...
  $.ajax({
                   ...
                   url:'get_info_dv.php',
                    success:function(data){
                      ...
                      $('#dv_no').val(result.dv_no);
                      $('#acct_no').val(result.account_no);
                      $('#cheque_no').val(result.cheque_no);
    ...
    $.ajax({
      type:'POST',
      data:{type:type,office:office,obr:obr,dv:dvno},
