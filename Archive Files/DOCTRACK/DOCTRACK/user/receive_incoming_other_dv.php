...
include('insert_received_dv.php'); //insert to tbl_ledger
include('insert_received_dv1.php'); //insert to tbl_documents and tbl_dv
...
$docno; ?>" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly  id="orig" class="form-control" name="origin" placeholder="Originating Office" value="<?php echo
$origin; ?>" required>
                  </div>
                </div><br>
...
$(function(){
  ...
  var type = $('#select_type').val();
    ...
    //  }else{
       ...
       $.ajax({
    type:'POST',
    data:{type:type,office:department,obr:obr},
