...
$fname = $mname = $lname = $contact_number = $email = $uname = $upass = $btnStatus = $department =
    '';
$btnNew = 'disabled';
            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" name="firstname" placeholder="Firstname" value="<?php echo
$fname; ?>" required>
                  </div>
                </div><br>
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" name="middlename" placeholder="Middlename" value="<?php echo
$mname; ?>" required>
                  </div>
                </div><br>
                <div class="row">
