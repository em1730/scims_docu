<?php include 'includes/session.php'; ?>
 ...
 <?php include 'insert_update_committee.php'; ?>
...
$get_committee; ?></textarea>
                ...
                <div class="row">
                                            ...
                                            <div class="col-md-9">
                                               ...
                                               <?php 
                                               if (isset($_GET['update_committee'])) {
...
<?php } ?>
             ...
             <div class="card-footer">
              <input type="submit"  <?php echo $btnNew; ?> name="add" class="btn btn-primary" value="New">
                <input type="submit"  <?php echo $btnStatus; ?> name="insert_update_committee" class="btn btn-primary" value="Save">
