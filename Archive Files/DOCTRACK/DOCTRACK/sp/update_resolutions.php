...
<?php include 'insert_update_resolution.php'; ?>
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
       <h1 class="m-0 text-dark">Update Resolution</h1>
      </div>
      <div class="col-sm-6">
                     ...
                     <div class="animationIN card card-outline card-primary">
                         ...
                         <form role="form" enctype="multipart/form-data" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
                             ...
                             <div class="card-body">
                                 ...
                                 <input hidden type="text" class="form-control" readOnly=true id = "resno2" name="resolution_no2" placeholder="Resolution Number" value="<?php echo $resolution; ?>">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-10">
                                         <input <?php echo $readonly; ?> type="text" class="form-control" id = "resno" name="resolution_no" placeholder="Resolution Number" value="<?php echo $resolution; ?>" required>
                                     </div>
                                 </div><br>
                                         ...
                                         <div class="form-group">
                                                 ...
                                                 <div class="input-group date mb-3" data-provide="datepicker" data-date-format="yyyy/mm/dd" data-date-today-btn="linked">
                                                     <div class="input-group-addon input-group-prepend">
                                                         ...
                                                         <input type="text" class="form-control pull-right" id="datepicker" name="date_approvedlce" placeholder="Date Approved LCE" value="<?php echo $dateapprovelce; ?>">
                                                 </div>
                                         </div>
                                     </div>
                                 </div><br>
                             ...
                             <div class="card-footer">
                                 <input type="submit" name="insert_update_resolution" class="btn btn-primary" value="Save">
                                 <a href="resolutions">
