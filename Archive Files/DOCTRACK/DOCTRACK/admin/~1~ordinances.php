...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SP DocuTrack</b>Sys</span>
    </a>
                ...
                <table id="users" class="table table-bordered table-striped">
                  ...
                  <?php while($ordinances_data = $get_all_ordinances_data->fetch(PDO::FETCH_ASSOC)){ ?>
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-outline-success btn-xs" href="update_user.php?userpass=<?php echo $user_data['userpass'];?>&id=<?php echo $user_data['user_id'];?> "><i class="fa fa-check-square-o"></i>
                          </a>
