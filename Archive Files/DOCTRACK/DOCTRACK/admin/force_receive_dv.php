...
<?php } ?>
                  ...
                  <div class="col-md-4">
                      <input type="text"   class="form-control" id="pr_no" name="pr_number"  placeholder="PR Number" value="<?php echo
$pr_no; ?>" >
                  </div>
                  ...
                  <div class="col-md-4">
                      <input type="text"    class="form-control" id="po_no" name="po_number"  placeholder="PO Number" value="<?php echo
$po_no; ?>">
                  </div>
                </div><br>
...
<!-- for PR & PO -->
                  ...
                  <div class="col-md-4">
                      ...
                      <input type="text"  <?php if ($department != 'CBO'){?> readonly  <?php } ?>  required class="form-control" id="obr_no" name="obr_number"  placeholder="OBR Number" value="<?php echo
$obr_no; ?>">
                  </div>
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control select2" readonly <?php if ($department == 'ACCTG'){?> required  <?php } ?> style="width: 100%;" id="select_account" name="account"  value="<?php echo $account; ?>">
                                                   <option>Please select...</option>
...
<?php } ?>
                  ...
                  <div class="col-md-4">
                      <input type="text"  readonly <?php if ($department == 'ACCTG'){?> required <?php } ?> class="form-control" id="dv_no" name="dv_number"  placeholder="DV Number" value="<?php echo
$dv_no; ?>" >
                  </div>
                                    </div><br>
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-4">
                      <input type="text" readonly class="form-control" id="acct_no" name="acct_number"  placeholder="Account Number" value="<?php echo
$acct_no; ?>">
                  </div>
                  <div class="col-md-1" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-4">
                      <input type="text" readonly <?php if ($department == 'CTO'){?> required <?php } ?> class="form-control" id="cheque_number" name="cheque_number"  placeholder="Cheque Number" value="<?php echo
$cheque_no; ?>">
                  </div>
                </div><br>
                ...
                <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control select2" readonly required style="width: 100%;" name="payee" value="<?php echo $payee; ?>">
                                                   <option>Please select...</option>
