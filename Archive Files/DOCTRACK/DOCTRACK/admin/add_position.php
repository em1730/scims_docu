            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control select2" id="select_department" name="department" style="width: 100%;" name="type" value="<?php echo
$position; ?>">
...
<?php } ?>
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" name="code" placeholder="Code" value="<?php echo
$objid; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <textarea rows="5" class="form-control" name="position" placeholder="Position"  required><?php echo
$newposition; ?></textarea>
                  </div>
                </div><br>
...
$status; ?>">
              ...
              <input type="submit"  <?php echo $btnNew; ?> name="add" class="btn btn-primary" value="New">
                <input type="submit"  <?php echo $btnStatus; ?> name="insert_position" class="btn btn-primary" value="Save">
                <a href="position">
