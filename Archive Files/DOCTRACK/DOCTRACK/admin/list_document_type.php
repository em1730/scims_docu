            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                <table id="users" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php while ($document_data = $get_all_document_data->
fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-outline-success btn-xs" href="update_document.php?orno=<?php echo
    ...
    $document_data['objid']; ?>"><i class="fa fa-search"></i>
                          ...
                          <button class="btn btn-outline-danger btn-xs" data-role="confirm_delete" data-id="<?php echo
$user_data["user_id"]; ?>"><i class="fa fa-trash-o"></i></button>
                        </td>
                      </tr>
