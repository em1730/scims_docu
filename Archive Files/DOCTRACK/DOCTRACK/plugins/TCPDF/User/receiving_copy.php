...
$update_document_sql = "UPDATE tbl_documents d inner join tbl_ledger l on d.docno = l.docno set d.print = :print WHERE l.txndate between '$date_from' and '$date_to' and l.status in ('FORWARDED','CREATED') and d.status in ('FORWARDED','CREATED') and l.receiver = '$user' and d.print = 0";
